...
*VeloPayments::FundingApi* | [**create_funding_request_v2**](docs/FundingApi.md#create_funding_request_v2) | **POST** /v2/sourceAccounts/{sourceAccountId}/fundingRequest | Create Funding Request
*VeloPayments::FundingApi* | [**create_funding_request_v3**](docs/FundingApi.md#create_funding_request_v3) | **POST** /v3/sourceAccounts/{sourceAccountId}/fundingRequest | Create Funding Request
*VeloPayments::FundingApi* | [**get_funding_account_v2**](docs/FundingApi.md#get_funding_account_v2) | **GET** /v2/fundingAccounts/{fundingAccountId} | Get Funding Account
*VeloPayments::FundingApi* | [**get_funding_accounts_v2**](docs/FundingApi.md#get_funding_accounts_v2) | **GET** /v2/fundingAccounts | Get Funding Accounts
*VeloPayments::FundingApi* | [**get_funding_by_id_v1**](docs/FundingApi.md#get_funding_by_id_v1) | **GET** /v1/fundings/{fundingId} | Get Funding
*VeloPayments::FundingApi* | [**list_funding_audit_deltas**](docs/FundingApi.md#list_funding_audit_deltas) | **GET** /v1/deltas/fundings | Get Funding Audit Delta
...
*VeloPayments::PayeePaymentChannelsApi* | [**create_payment_channel_v4**](docs/PayeePaymentChannelsApi.md#create_payment_channel_v4) | **POST** /v4/payees/{payeeId}/paymentChannels/ | Create Payment Channel
*VeloPayments::PayeePaymentChannelsApi* | [**delete_payment_channel_v4**](docs/PayeePaymentChannelsApi.md#delete_payment_channel_v4) | **DELETE** /v4/payees/{payeeId}/paymentChannels/{paymentChannelId} | Delete Payment Channel
*VeloPayments::PayeePaymentChannelsApi* | [**enable_payment_channel_v4**](docs/PayeePaymentChannelsApi.md#enable_payment_channel_v4) | **POST** /v4/payees/{payeeId}/paymentChannels/{paymentChannelId}/enable | Enable Payment Channel
*VeloPayments::PayeePaymentChannelsApi* | [**get_payment_channel_v4**](docs/PayeePaymentChannelsApi.md#get_payment_channel_v4) | **GET** /v4/payees/{payeeId}/paymentChannels/{paymentChannelId} | Get Payment Channel Details
*VeloPayments::PayeePaymentChannelsApi* | [**get_payment_channels_v4**](docs/PayeePaymentChannelsApi.md#get_payment_channels_v4) | **GET** /v4/payees/{payeeId}/paymentChannels/ | Get All Payment Channels Details
*VeloPayments::PayeePaymentChannelsApi* | [**update_payment_channel_order_v4**](docs/PayeePaymentChannelsApi.md#update_payment_channel_order_v4) | **PUT** /v4/payees/{payeeId}/paymentChannels/order | Update Payees preferred Payment Channel order
*VeloPayments::PayeePaymentChannelsApi* | [**update_payment_channel_v4**](docs/PayeePaymentChannelsApi.md#update_payment_channel_v4) | **POST** /v4/payees/{payeeId}/paymentChannels/{paymentChannelId} | Update Payment Channel
...
*VeloPayments::PayorHierarchyApi* | [**payor_links_v1**](docs/PayorHierarchyApi.md#payor_links_v1) | **GET** /v1/payorLinks | List Payor Links
*VeloPayments::PayorsApi* | [**get_payor_by_id_v2**](docs/PayorsApi.md#get_payor_by_id_v2) | **GET** /v2/payors/{payorId} | Get Payor
*VeloPayments::PayorsApi* | [**payor_add_payor_logo_v1**](docs/PayorsApi.md#payor_add_payor_logo_v1) | **POST** /v1/payors/{payorId}/branding/logos | Add Logo
*VeloPayments::PayorsApi* | [**payor_create_api_key_v1**](docs/PayorsApi.md#payor_create_api_key_v1) | **POST** /v1/payors/{payorId}/applications/{applicationId}/keys | Create API Key
*VeloPayments::PayorsApi* | [**payor_create_application_v1**](docs/PayorsApi.md#payor_create_application_v1) | **POST** /v1/payors/{payorId}/applications | Create Application
...
*VeloPayments::PayoutsApi* | [**create_quote_for_payout_v3**](docs/PayoutsApi.md#create_quote_for_payout_v3) | **POST** /v3/payouts/{payoutId}/quote | Create a quote for the payout
*VeloPayments::PayoutsApi* | [**deschedule_payout**](docs/PayoutsApi.md#deschedule_payout) | **DELETE** /v3/payouts/{payoutId}/schedule | Deschedule a payout
*VeloPayments::PayoutsApi* | [**get_payments_for_payout_v3**](docs/PayoutsApi.md#get_payments_for_payout_v3) | **GET** /v3/payouts/{payoutId}/payments | Retrieve payments for a payout
*VeloPayments::PayoutsApi* | [**get_payout_summary_v3**](docs/PayoutsApi.md#get_payout_summary_v3) | **GET** /v3/payouts/{payoutId} | Get Payout Summary
*VeloPayments::PayoutsApi* | [**instruct_payout_v3**](docs/PayoutsApi.md#instruct_payout_v3) | **POST** /v3/payouts/{payoutId} | Instruct Payout
*VeloPayments::PayoutsApi* | [**schedule_for_payout**](docs/PayoutsApi.md#schedule_for_payout) | **POST** /v3/payouts/{payoutId}/schedule | Schedule a payout
*VeloPayments::PayoutsApi* | [**submit_payout_v3**](docs/PayoutsApi.md#submit_payout_v3) | **POST** /v3/payouts | Submit Payout
*VeloPayments::PayoutsApi* | [**withdraw_payment**](docs/PayoutsApi.md#withdraw_payment) | **POST** /v1/payments/{paymentId}/withdraw | Withdraw a Payment
*VeloPayments::PayoutsApi* | [**withdraw_payout_v3**](docs/PayoutsApi.md#withdraw_payout_v3) | **DELETE** /v3/payouts/{payoutId} | Withdraw Payout
*VeloPayments::SourceAccountsApi* | [**get_source_account_v2**](docs/SourceAccountsApi.md#get_source_account_v2) | **GET** /v2/sourceAccounts/{sourceAccountId} | Get Source Account
*VeloPayments::SourceAccountsApi* | [**get_source_account_v3**](docs/SourceAccountsApi.md#get_source_account_v3) | **GET** /v3/sourceAccounts/{sourceAccountId} | Get details about given source account.
*VeloPayments::SourceAccountsApi* | [**get_source_accounts_v2**](docs/SourceAccountsApi.md#get_source_accounts_v2) | **GET** /v2/sourceAccounts | Get list of source accounts
*VeloPayments::SourceAccountsApi* | [**get_source_accounts_v3**](docs/SourceAccountsApi.md#get_source_accounts_v3) | **GET** /v3/sourceAccounts | Get list of source accounts
*VeloPayments::SourceAccountsApi* | [**set_notifications_request**](docs/SourceAccountsApi.md#set_notifications_request) | **POST** /v1/sourceAccounts/{sourceAccountId}/notifications | Set notifications
*VeloPayments::SourceAccountsApi* | [**set_notifications_request_v3**](docs/SourceAccountsApi.md#set_notifications_request_v3) | **POST** /v3/sourceAccounts/{sourceAccountId}/notifications | Set notifications
*VeloPayments::SourceAccountsApi* | [**transfer_funds_v2**](docs/SourceAccountsApi.md#transfer_funds_v2) | **POST** /v2/sourceAccounts/{sourceAccountId}/transfers | Transfer Funds between source accounts
*VeloPayments::SourceAccountsApi* | [**transfer_funds_v3**](docs/SourceAccountsApi.md#transfer_funds_v3) | **POST** /v3/sourceAccounts/{sourceAccountId}/transfers | Transfer Funds between source accounts
*VeloPayments::TokensApi* | [**resend_token**](docs/TokensApi.md#resend_token) | **POST** /v2/users/{userId}/tokens | Resend a token
*VeloPayments::TransactionsApi* | [**create_transaction_v1**](docs/TransactionsApi.md#create_transaction_v1) | **POST** /v1/transactions | Create a Transaction
*VeloPayments::TransactionsApi* | [**get_transaction_by_id_v1**](docs/TransactionsApi.md#get_transaction_by_id_v1) | **GET** /v1/transactions/{transactionId} | Get Transaction
*VeloPayments::TransactionsApi* | [**get_transactions**](docs/TransactionsApi.md#get_transactions) | **GET** /v1/transactions | Get Transactions
...
## Documentation for Models
 ...
 - [VeloPayments::AddressV4](docs/AddressV4.md)
 - [VeloPayments::AuthResponse](docs/AuthResponse.md)
 - [VeloPayments::AutoTopUpConfigV2](docs/AutoTopUpConfigV2.md)
 - [VeloPayments::AutoTopUpConfigV3](docs/AutoTopUpConfigV3.md)
 ...
 - [VeloPayments::CommonLinkObject](docs/CommonLinkObject.md)
 - [VeloPayments::CommonPageObject](docs/CommonPageObject.md)
 ...
 - [VeloPayments::CreatePaymentChannelRequestV4](docs/CreatePaymentChannelRequestV4.md)
 ...
 - [VeloPayments::CreateTransactionRequest](docs/CreateTransactionRequest.md)
 - [VeloPayments::CreateTransactionResponse](docs/CreateTransactionResponse.md)
 ...
 - [VeloPayments::FundingAccountResponseV2](docs/FundingAccountResponseV2.md)
 - [VeloPayments::FundingAudit](docs/FundingAudit.md)
 - [VeloPayments::FundingEvent](docs/FundingEvent.md)
 - [VeloPayments::FundingEvent2](docs/FundingEvent2.md)
 ...
 - [VeloPayments::FundingResponse](docs/FundingResponse.md)
 ...
 - [VeloPayments::InstructPayoutRequestV3](docs/InstructPayoutRequestV3.md)
 ...
 - [VeloPayments::ListFundingAccountsResponseV2](docs/ListFundingAccountsResponseV2.md)
 - [VeloPayments::ListFundingAccountsResponseV2Page](docs/ListFundingAccountsResponseV2Page.md)
 ...
 - [VeloPayments::NotificationSource](docs/NotificationSource.md)
 - [VeloPayments::NotificationsV2](docs/NotificationsV2.md)
 - [VeloPayments::NotificationsV3](docs/NotificationsV3.md)
 ...
 - [VeloPayments::PageResourceTransactions](docs/PageResourceTransactions.md)
 ...
 - [VeloPayments::PayeeTypeEnum](docs/PayeeTypeEnum.md)
 ...
 - [VeloPayments::PaymentChannelOrderRequestV4](docs/PaymentChannelOrderRequestV4.md)
 - [VeloPayments::PaymentChannelResponseV4](docs/PaymentChannelResponseV4.md)
 ...
 - [VeloPayments::PaymentChannelSummaryV4](docs/PaymentChannelSummaryV4.md)
 - [VeloPayments::PaymentChannelsResponseV4](docs/PaymentChannelsResponseV4.md)
 ...
 - [VeloPayments::PayorFundingDetected](docs/PayorFundingDetected.md)
 - [VeloPayments::PayorFundingDetectedAllOf](docs/PayorFundingDetectedAllOf.md)
 ...
 - [VeloPayments::PayorToPaymentChannelMappingV4](docs/PayorToPaymentChannelMappingV4.md)
 ...
 - [VeloPayments::PayoutScheduleV3](docs/PayoutScheduleV3.md)
 ...
 - [VeloPayments::PostInstructFxInfo](docs/PostInstructFxInfo.md)
 ...
 - [VeloPayments::SchedulePayoutRequestV3](docs/SchedulePayoutRequestV3.md)
 ...
 - [VeloPayments::SetNotificationsRequest2](docs/SetNotificationsRequest2.md)
 ...
 - [VeloPayments::TransactionResponse](docs/TransactionResponse.md)
 - [VeloPayments::TransferRequestV2](docs/TransferRequestV2.md)
 - [VeloPayments::TransferRequestV3](docs/TransferRequestV3.md)
 ...
 - [VeloPayments::UpdatePaymentChannelRequestV4](docs/UpdatePaymentChannelRequestV4.md)
