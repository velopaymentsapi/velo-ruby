...
```shell
gem install ./velopayments-.gem
```

(for development, run `gem install --dev ./velopayments-.gem` to install the development dependencies)
...
*VeloPayments::PayorsApi* | [**get_payor_by_id_v1**](docs/PayorsApi.md#get_payor_by_id_v1) | **GET** /v1/payors/{payorId} | Get Payor
...
## Documentation for Models
 ...
 - [VeloPayments::ListFundingAccountsResponseV2Links](docs/ListFundingAccountsResponseV2Links.md)
