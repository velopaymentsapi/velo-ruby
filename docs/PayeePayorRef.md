...
| **payable_issues** | [**Array&lt;PayableIssue2&gt;**](PayableIssue2.md) | Indicates any conditions which prevent the payee from being payable for this payor | [optional] |
...
instance = VeloPayments::PayeePayorRef.new(
