...
------------- | ------------- | -------------
[**get_payor**](PayeeInvitationApi.md#get_payor) | **GET** /v1/payees/payors/{payorId}/invitationStatus | Get Payee Invitation Status
...
> InvitationStatusResponse get_payor(payor_id)
...
begin
  #Get Payee Invitation Status
  result = api_instance.get_payor(payor_id)
  p result
rescue VeloPayments::ApiError => e
  puts "Exception when calling PayeeInvitationApi->get_payor: #{e}"
end
```
