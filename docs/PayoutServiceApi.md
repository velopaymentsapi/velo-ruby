...
begin
  ...
  puts "Exception when calling PayoutServiceApi->create_quote_for_payout_v3: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling PayoutServiceApi->get_payments_for_payout_v3: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling PayoutServiceApi->get_payout_summary_v3: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling PayoutServiceApi->instruct_payout_v3: #{e}"
end
```
...
api_instance = VeloPayments::PayoutServiceApi.new
create_payout_request_v3 = VeloPayments::CreatePayoutRequestV3.new # CreatePayoutRequestV3 | Post amount to transfer using stored funding account details.

begin
  #Submit Payout
  api_instance.submit_payout_v3(create_payout_request_v3)
rescue VeloPayments::ApiError => e
  puts "Exception when calling PayoutServiceApi->submit_payout_v3: #{e}"
end
```
...
withdraw_payment_request = VeloPayments::WithdrawPaymentRequest.new # WithdrawPaymentRequest | details for withdrawal

begin
  #Withdraw a Payment
  api_instance.withdraw_payment(payment_id, withdraw_payment_request)
rescue VeloPayments::ApiError => e
  puts "Exception when calling PayoutServiceApi->withdraw_payment: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling PayoutServiceApi->withdraw_payout_v3: #{e}"
end
```
