...
# Unit tests for VeloPayments::CreateWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VeloPayments::CreateWebhookRequest do
  let(:instance) { VeloPayments::CreateWebhookRequest.new }

  describe 'test an instance of CreateWebhookRequest' do
    it 'should create an instance of CreateWebhookRequest' do
      expect(instance).to be_instance_of(VeloPayments::CreateWebhookRequest)
    end
  end
