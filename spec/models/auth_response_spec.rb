...
# Unit tests for VeloPayments::AuthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VeloPayments::AuthResponse do
  let(:instance) { VeloPayments::AuthResponse.new }

  describe 'test an instance of AuthResponse' do
    it 'should create an instance of AuthResponse' do
      expect(instance).to be_instance_of(VeloPayments::AuthResponse)
    end
  end
