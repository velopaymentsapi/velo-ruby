...
# Unit tests for VeloPayments::AccessTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VeloPayments::AccessTokenResponse do
  let(:instance) { VeloPayments::AccessTokenResponse.new }

  describe 'test an instance of AccessTokenResponse' do
    it 'should create an instance of AccessTokenResponse' do
      expect(instance).to be_instance_of(VeloPayments::AccessTokenResponse)
    end
  end
