...
# Unit tests for VeloPayments::PaymentEventResponseV3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VeloPayments::PaymentEventResponseV3 do
  let(:instance) { VeloPayments::PaymentEventResponseV3.new }

  describe 'test an instance of PaymentEventResponseV3' do
    it 'should create an instance of PaymentEventResponseV3' do
      expect(instance).to be_instance_of(VeloPayments::PaymentEventResponseV3)
    end
  end
