...
# Unit tests for VeloPayments::Notification
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VeloPayments::Notification do
  let(:instance) { VeloPayments::Notification.new }

  describe 'test an instance of Notification' do
    it 'should create an instance of Notification' do
      expect(instance).to be_instance_of(VeloPayments::Notification)
    end
  end
