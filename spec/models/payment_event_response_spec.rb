...
# Unit tests for VeloPayments::PaymentEventResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VeloPayments::PaymentEventResponse do
  let(:instance) { VeloPayments::PaymentEventResponse.new }

  describe 'test an instance of PaymentEventResponse' do
    it 'should create an instance of PaymentEventResponse' do
      expect(instance).to be_instance_of(VeloPayments::PaymentEventResponse)
    end
  end
