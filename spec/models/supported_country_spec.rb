...
describe 'SupportedCountry' do
  ...
  describe 'test attribute "iso_country_code"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["US", "GB", "FR", "CA", "JP"])
  ...
  describe 'test attribute "currencies"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["USD", "GBP", "EUR", "CAD", "JPY"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.currencies = value }.not_to raise_error
      # end
    end
  end
