...
# Unit tests for VeloPayments::Company
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VeloPayments::Company do
  let(:instance) { VeloPayments::Company.new }

  describe 'test an instance of Company' do
    it 'should create an instance of Company' do
      expect(instance).to be_instance_of(VeloPayments::Company)
    end
  end
