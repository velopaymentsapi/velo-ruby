...
describe 'FundingManagerApi' do
  ...
  # @param funding_request Body to included ammount to be funded
  ...
  # Instruct a funding request to transfer funds from the payor’s funding bank to the payor’s balance held within Velo  (202 - accepted, 400 - invalid request body, 404 - source account not found).
  # @param source_account_id Source account id
  # @param funding_request2 Body to included ammount to be funded
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  # unit tests for set_payor_funding_bank_details
  ...
  # @param payor_funding_bank_details_update Update Funding bank details of given Payor Id
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'set_payor_funding_bank_details test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
