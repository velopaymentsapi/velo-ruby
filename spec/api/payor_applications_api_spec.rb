...
# Unit tests for VeloPayments::PayorApplicationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PayorApplicationsApi' do
  before do
  ...
  describe 'test an instance of PayorApplicationsApi' do
    it 'should create an instance of PayorApplicationsApi' do
      expect(@api_instance).to be_instance_of(VeloPayments::PayorApplicationsApi)
    end
  end
