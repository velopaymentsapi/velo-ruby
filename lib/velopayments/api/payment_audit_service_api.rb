...
module VeloPayments
  class PaymentAuditServiceApi
    ...
    def export_transactions_csvv4_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PayorAmlTransactionV4'
    ...
    def get_payments_for_payout_with_http_info(payout_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PaymentAuditServiceApi.get_payments_for_payout",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_payouts_for_payor_v4_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPayoutsResponseV4'
    ...
    def list_payment_changes_v4_with_http_info(payor_id, updated_since, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaymentDeltaResponseV4'
