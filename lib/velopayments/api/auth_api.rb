...
module VeloPayments
  class AuthApi
    ...
    # @return [AuthResponse]
    def velo_auth(authorization, opts = {})
      data, _status_code, _headers = velo_auth_with_http_info(authorization, opts)
      data
    end
    ...
    def velo_auth_with_http_info(authorization, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuthApi.velo_auth ...'
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling AuthApi.velo_auth"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthApi#velo_auth\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
