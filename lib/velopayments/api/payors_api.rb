...
module VeloPayments
  class PayorsApi
    ...
    # @return [nil]
    def payor_add_payor_logo_v1(payor_id, opts = {})
      payor_add_payor_logo_v1_with_http_info(payor_id, opts)
      nil
    end
    ...
    def payor_add_payor_logo_v1_with_http_info(payor_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PayorsApi.payor_add_payor_logo_v1 ...'
      end
      # verify the required parameter 'payor_id' is set
      if @api_client.config.client_side_validation && payor_id.nil?
        fail ArgumentError, "Missing the required parameter 'payor_id' when calling PayorsApi.payor_add_payor_logo_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PayorsApi.payor_add_payor_logo_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PayorsApi#payor_add_payor_logo_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def payor_create_api_key_v1(payor_id, application_id, payor_create_api_key_request, opts = {})
      data, _status_code, _headers = payor_create_api_key_v1_with_http_info(payor_id, application_id, payor_create_api_key_request, opts)
      data
    end
    ...
    def payor_create_api_key_v1_with_http_info(payor_id, application_id, payor_create_api_key_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PayorsApi.payor_create_api_key_v1 ...'
      end
      # verify the required parameter 'payor_id' is set
      if @api_client.config.client_side_validation && payor_id.nil?
        fail ArgumentError, "Missing the required parameter 'payor_id' when calling PayorsApi.payor_create_api_key_v1"
      end
      # verify the required parameter 'application_id' is set
      if @api_client.config.client_side_validation && application_id.nil?
        fail ArgumentError, "Missing the required parameter 'application_id' when calling PayorsApi.payor_create_api_key_v1"
      end
      ...
      if @api_client.config.client_side_validation && payor_create_api_key_request.nil?
        fail ArgumentError, "Missing the required parameter 'payor_create_api_key_request' when calling PayorsApi.payor_create_api_key_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PayorsApi.payor_create_api_key_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PayorsApi#payor_create_api_key_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def payor_create_application_v1(payor_id, payor_create_application_request, opts = {})
      payor_create_application_v1_with_http_info(payor_id, payor_create_application_request, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def payor_create_application_v1_with_http_info(payor_id, payor_create_application_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PayorsApi.payor_create_application_v1 ...'
      end
      # verify the required parameter 'payor_id' is set
      if @api_client.config.client_side_validation && payor_id.nil?
        fail ArgumentError, "Missing the required parameter 'payor_id' when calling PayorsApi.payor_create_application_v1"
      end
      ...
      if @api_client.config.client_side_validation && payor_create_application_request.nil?
        fail ArgumentError, "Missing the required parameter 'payor_create_application_request' when calling PayorsApi.payor_create_application_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PayorsApi.payor_create_application_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PayorsApi#payor_create_application_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
