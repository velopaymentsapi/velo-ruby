...
module VeloPayments
  class PayorsApi
    ...
    # @return [PayorV1]
    def get_payor_by_id_v1(payor_id, opts = {})
      data, _status_code, _headers = get_payor_by_id_v1_with_http_info(payor_id, opts)
      data
    end
    ...
    def get_payor_by_id_v1_with_http_info(payor_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PayorsApi.get_payor_by_id_v1 ...'
      end
      # verify the required parameter 'payor_id' is set
      if @api_client.config.client_side_validation && payor_id.nil?
        fail ArgumentError, "Missing the required parameter 'payor_id' when calling PayorsApi.get_payor_by_id_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PayorsApi.get_payor_by_id_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PayorsApi#get_payor_by_id_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
