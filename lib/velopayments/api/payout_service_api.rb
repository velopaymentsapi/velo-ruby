...
module VeloPayments
  class PayoutServiceApi
    ...
    def create_quote_for_payout_v3_with_http_info(payout_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'QuoteResponseV3' 
    ...
    def get_payments_for_payout_v3_with_http_info(payout_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PagedPaymentsResponseV3' 
    ...
    def get_payout_summary_v3_with_http_info(payout_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'PayoutSummaryResponseV3' 
    ...
    def submit_payout_v3_with_http_info(create_payout_request_v3, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_payout_request_v3) 
    ...
    def withdraw_payment_with_http_info(payment_id, withdraw_payment_request, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(withdraw_payment_request) 
