...
module VeloPayments
  class FundingManagerApi
    ...
    def create_funding_request_v3_with_http_info(source_account_id, funding_request_v3, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(funding_request_v3) 
    ...
    def get_funding_account_v2_with_http_info(funding_account_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'FundingAccountResponse2' 
    ...
    def get_funding_accounts_v2_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ListFundingAccountsResponse2' 
    ...
    def get_source_account_v3_with_http_info(source_account_id, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'SourceAccountResponseV3' 
    ...
    def get_source_accounts_v3_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ListSourceAccountResponseV3' 
    ...
    def transfer_funds_v3_with_http_info(source_account_id, transfer_request2, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(transfer_request2) 
