...
module VeloPayments
  class FundingManagerApi
    ...
    # @param payor_id [String] The Payor ID to find associated funding records
    ...
    # @return [Array<(FundingDeltaResponse, Integer, Hash)>] FundingDeltaResponse data, response status code and response headers
    def list_funding_audit_deltas_with_http_info(payor_id, updated_since, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'FundingDeltaResponse' 
