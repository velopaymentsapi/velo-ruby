...
module VeloPayments
  class FundingManagerApi
    ...
    def create_ach_funding_request_with_http_info(source_account_id, funding_request_v1, opts = {})
      ...
      # resource path
      local_var_path = '/v1/sourceAccounts/{sourceAccountId}/achFundingRequest'.sub('{' + 'sourceAccountId' + '}', CGI.escape(source_account_id.to_s).gsub('%2F', '/'))
    ...
    # Instruct a funding request to transfer funds from the payor’s funding bank to the payor’s balance held within Velo  (202 - accepted, 400 - invalid request body, 404 - source account not found).
    # @param source_account_id [String] Source account id
    # @param funding_request_v2 [FundingRequestV2] Body to included ammount to be funded
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def create_funding_request_with_http_info(source_account_id, funding_request_v2, opts = {})
      ...
      # resource path
      local_var_path = '/v2/sourceAccounts/{sourceAccountId}/fundingRequest'.sub('{' + 'sourceAccountId' + '}', CGI.escape(source_account_id.to_s).gsub('%2F', '/'))
    ...
    def get_source_account_with_http_info(source_account_id, opts = {})
      ...
      # resource path
      local_var_path = '/v1/sourceAccounts/{sourceAccountId}'.sub('{' + 'sourceAccountId' + '}', CGI.escape(source_account_id.to_s).gsub('%2F', '/'))
    ...
    def get_source_account_v2_with_http_info(source_account_id, opts = {})
      ...
      # resource path
      local_var_path = '/v2/sourceAccounts/{sourceAccountId}'.sub('{' + 'sourceAccountId' + '}', CGI.escape(source_account_id.to_s).gsub('%2F', '/'))
    ...
    def set_notifications_request_with_http_info(source_account_id, set_notifications_request, opts = {})
      ...
      # resource path
      local_var_path = '/v1/sourceAccounts/{sourceAccountId}/notifications'.sub('{' + 'sourceAccountId' + '}', CGI.escape(source_account_id.to_s).gsub('%2F', '/'))
    ...
    def set_payor_funding_bank_details_with_http_info(payor_id, payor_funding_bank_details_update, opts = {})
      ...
      # resource path
      local_var_path = '/v1/payors/{payorId}/payorFundingBankDetailsUpdate'.sub('{' + 'payorId' + '}', CGI.escape(payor_id.to_s).gsub('%2F', '/'))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(payor_funding_bank_details_update) 
