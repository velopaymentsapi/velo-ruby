...
module VeloPayments
  class CountriesApi
    ...
    def list_supported_countries_v1(opts = {})
      data, _status_code, _headers = list_supported_countries_v1_with_http_info(opts)
      data
    end
    ...
    def list_supported_countries_v1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CountriesApi.list_supported_countries_v1 ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CountriesApi#list_supported_countries_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
