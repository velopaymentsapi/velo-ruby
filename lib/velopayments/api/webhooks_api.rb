...
module VeloPayments
  class WebhooksApi
    ...
    # @return [nil]
    def create_webhook_v1(opts = {})
      create_webhook_v1_with_http_info(opts)
      nil
    end
    ...
    def create_webhook_v1_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhooksApi.create_webhook_v1 ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"WebhooksApi.create_webhook_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhooksApi#create_webhook_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_webhook_v1(webhook_id, opts = {})
      data, _status_code, _headers = get_webhook_v1_with_http_info(webhook_id, opts)
      data
    end
    ...
    def get_webhook_v1_with_http_info(webhook_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhooksApi.get_webhook_v1 ...'
      end
      # verify the required parameter 'webhook_id' is set
      if @api_client.config.client_side_validation && webhook_id.nil?
        fail ArgumentError, "Missing the required parameter 'webhook_id' when calling WebhooksApi.get_webhook_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"WebhooksApi.get_webhook_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhooksApi#get_webhook_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_webhooks_v1(payor_id, opts = {})
      data, _status_code, _headers = list_webhooks_v1_with_http_info(payor_id, opts)
      data
    end
    ...
    def list_webhooks_v1_with_http_info(payor_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhooksApi.list_webhooks_v1 ...'
      end
      # verify the required parameter 'payor_id' is set
      if @api_client.config.client_side_validation && payor_id.nil?
        fail ArgumentError, "Missing the required parameter 'payor_id' when calling WebhooksApi.list_webhooks_v1"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 100
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling WebhooksApi.list_webhooks_v1, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling WebhooksApi.list_webhooks_v1, must be greater than or equal to 1.'
      end
      ...
      new_options = opts.merge(
        :operation => :"WebhooksApi.list_webhooks_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhooksApi#list_webhooks_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [nil]
    def update_webhook_v1(webhook_id, opts = {})
      update_webhook_v1_with_http_info(webhook_id, opts)
      nil
    end
    ...
    # @option opts [UpdateWebhookRequest] :update_webhook_request 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_webhook_v1_with_http_info(webhook_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhooksApi.update_webhook_v1 ...'
      end
      # verify the required parameter 'webhook_id' is set
      if @api_client.config.client_side_validation && webhook_id.nil?
        fail ArgumentError, "Missing the required parameter 'webhook_id' when calling WebhooksApi.update_webhook_v1"
      end
      # resource path
      local_var_path = '/v1/webhooks/{webhookId}'.sub('{' + 'webhookId' + '}', CGI.escape(webhook_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WebhooksApi.update_webhook_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhooksApi#update_webhook_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
