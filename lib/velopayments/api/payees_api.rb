...
module VeloPayments
  class PayeesApi
    ...
    # @param payee_id [String] The UUID of the payee.
    # @param update_remote_id_request2 [UpdateRemoteIdRequest2] Request to update payee remote id v4
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def v4_payees_payee_id_remote_id_update_post(payee_id, update_remote_id_request2, opts = {})
      v4_payees_payee_id_remote_id_update_post_with_http_info(payee_id, update_remote_id_request2, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def v4_payees_payee_id_remote_id_update_post_with_http_info(payee_id, update_remote_id_request2, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && update_remote_id_request2.nil?
        fail ArgumentError, "Missing the required parameter 'update_remote_id_request2' when calling PayeesApi.v4_payees_payee_id_remote_id_update_post"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_remote_id_request2)
