...
module VeloPayments
  class SourceAccountResponse
    ...
    def hash
      [id, balance, currency, funding_ref, physical_account_name, rails_id, payor_id, name, pooled, balance_visible, customer_id, physical_account_id, funding_account_id, account_type].hash
    end
