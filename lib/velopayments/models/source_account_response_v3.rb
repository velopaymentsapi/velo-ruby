...
module VeloPayments
  class SourceAccountResponseV3
    ...
    def hash
      [id, balance, currency, funding_ref, physical_account_name, rails_id, payor_id, name, pooled, customer_id, physical_account_id, notifications, auto_top_up_config, type, country, archived].hash
    end
