...
module VeloPayments
  class SourceAccountResponseV3
    ...
    def self.openapi_types
      {
        ...
        :'auto_top_up_config' => :'AutoTopUpConfig2',
        :'type' => :'String',
        :'country' => :'String',
        :'deleted' => :'Boolean',
    ...
    def valid?
      ...
      currency_validator = EnumAttributeValidator.new('String', ["USD", "EUR", "GBP", "CAD", "HKD"])
    ...
    def currency=(currency)
      validator = EnumAttributeValidator.new('String', ["USD", "EUR", "GBP", "CAD", "HKD"])
    ...
    def hash
      [id, balance, currency, funding_ref, physical_account_name, rails_id, payor_id, name, pooled, customer_id, physical_account_id, notifications, auto_top_up_config, type, country, deleted, user_deleted, deleted_at].hash
    end
