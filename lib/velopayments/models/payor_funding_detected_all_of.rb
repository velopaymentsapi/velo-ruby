...
module VeloPayments
  class PayorFundingDetectedAllOf
    ...
    attr_accessor :physical_account_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::PayorFundingDetectedAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::PayorFundingDetectedAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'funding_request_id')
        self.funding_request_id = attributes[:'funding_request_id']
      else
        self.funding_request_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @funding_request_id.nil?
        invalid_properties.push('invalid value for "funding_request_id", funding_request_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @funding_request_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rails_id == o.rails_id &&
          payor_id == o.payor_id &&
          funding_request_id == o.funding_request_id &&
    ...
    def hash
      [rails_id, payor_id, funding_request_id, funding_ref, currency, amount, physical_account_name, source_account_name, source_account_id, additional_information, transaction_id, transaction_reference].hash
    end
