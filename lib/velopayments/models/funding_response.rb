...
module VeloPayments
  class FundingResponse
    ...
    attr_accessor :detected_funding_ref
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::FundingResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::FundingResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'detected_funding_ref')
        self.detected_funding_ref = attributes[:'detected_funding_ref']
      end
      ...
      if attributes.key?(:'hidden_date')
        self.hidden_date = attributes[:'hidden_date']
      end

      if attributes.key?(:'funding_account_type')
        self.funding_account_type = attributes[:'funding_account_type']
      else
        self.funding_account_type = nil
      end
    ...
    def list_invalid_properties
      ...
      if @funding_account_type.nil?
        invalid_properties.push('invalid value for "funding_account_type", funding_account_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @funding_account_type.nil?
