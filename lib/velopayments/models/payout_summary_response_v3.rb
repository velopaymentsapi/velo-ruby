...
module VeloPayments
  class PayoutSummaryResponseV3
    ...
    attr_accessor :payments_submitted

    # The number of payments that were accepted in the payout
    attr_accessor :payments_accepted
    ...
    attr_accessor :rejected_payments
    ...
    def hash
      [payout_id, status, payments_submitted, payments_accepted, payments_rejected, payments_withdrawn, fx_summaries, accounts, accepted_payments, rejected_payments, schedule].hash
    end
