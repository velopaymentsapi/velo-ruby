...
module VeloPayments
  ...
  class PayoutSchedule
    ...
    attr_accessor :scheduled_by_principal_id
    ...
    def self.openapi_types
      {
        ...
        :'scheduled_at' => :'Time',
        :'scheduled_for' => :'Time',
        :'scheduled_by_principal_id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::PayoutSchedule` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::PayoutSchedule`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'scheduled_by_principal_id')
        self.scheduled_by_principal_id = attributes[:'scheduled_by_principal_id']
      else
        self.scheduled_by_principal_id = nil
      end
      ...
      if attributes.key?(:'scheduled_by')
        self.scheduled_by = attributes[:'scheduled_by']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @schedule_status.nil?
        invalid_properties.push('invalid value for "schedule_status", schedule_status cannot be nil.')
      end
      ...
      if @scheduled_by_principal_id.nil?
        invalid_properties.push('invalid value for "scheduled_by_principal_id", scheduled_by_principal_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @schedule_status.nil?
      return false if @scheduled_at.nil?
      return false if @scheduled_for.nil?
      return false if @scheduled_by_principal_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scheduled_by_principal_id == o.scheduled_by_principal_id &&
    ...
    def hash
      [schedule_status, scheduled_at, scheduled_for, scheduled_by_principal_id, notifications_enabled, scheduled_by].hash
    end
