...
module VeloPayments
  class PaymentEventResponse
    ...
    def hash
      [event_id, event_date_time, event_type, source_currency, source_amount, payment_currency, payment_amount, account_number, routing_number, iban, account_name, principal, scheduled_at, scheduled_for, scheduled_by].hash
    end
