...
module VeloPayments
  ...
  class PaymentInstructionV3
    ...
    def list_invalid_properties
      ...
      if !@source_account_name.nil? && @source_account_name.to_s.length > 64
        invalid_properties.push('invalid value for "source_account_name", the character length must be smaller than or equal to 64.')
      end

      if !@source_account_name.nil? && @source_account_name.to_s.length < 1
    ...
    def valid?
      ...
      return false if !@source_account_name.nil? && @source_account_name.to_s.length > 64
      return false if !@source_account_name.nil? && @source_account_name.to_s.length < 1
    ...
    def hash
      [remote_id, currency, amount, payment_memo, source_account_name, transaction_id, payor_payment_id, transmission_type, remote_system_id, payment_metadata].hash
    end
