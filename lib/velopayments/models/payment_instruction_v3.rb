...
module VeloPayments
  ...
  class PaymentInstructionV3
    ...
    def valid?
      ...
      transmission_type_validator = EnumAttributeValidator.new('String', ["SAME_DAY_ACH", "WIRE", "ACH", "LOCAL", "SWIFT"])
      return false unless transmission_type_validator.valid?(@transmission_type)
    ...
    # @param [Object] transmission_type Object to be assigned
    def transmission_type=(transmission_type)
      validator = EnumAttributeValidator.new('String', ["SAME_DAY_ACH", "WIRE", "ACH", "LOCAL", "SWIFT"])
      unless validator.valid?(transmission_type)
        fail ArgumentError, "invalid value for \"transmission_type\", must be one of #{validator.allowable_values}."
      end
