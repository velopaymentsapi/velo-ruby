...
module VeloPayments
  ...
  class DebitStatusChanged
    ...
    attr_accessor :debit_transaction_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::DebitStatusChanged` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::DebitStatusChanged`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'debit_transaction_id')
        self.debit_transaction_id = attributes[:'debit_transaction_id']
      else
        self.debit_transaction_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @debit_transaction_id.nil?
        invalid_properties.push('invalid value for "debit_transaction_id", debit_transaction_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @debit_transaction_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          debit_transaction_id == o.debit_transaction_id &&
          status == o.status
    end
    ...
    def hash
      [source_type, event_id, created_at, debit_transaction_id, status].hash
    end
