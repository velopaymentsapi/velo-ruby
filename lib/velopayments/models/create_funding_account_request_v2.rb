...
module VeloPayments
  class CreateFundingAccountRequestV2
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["FBO", "WUBS_DECOUPLED", "PRIVATE"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["FBO", "WUBS_DECOUPLED", "PRIVATE"])
    ...
    def hash
      [type, name, payor_id, account_name, account_number, routing_number, currency].hash
    end
