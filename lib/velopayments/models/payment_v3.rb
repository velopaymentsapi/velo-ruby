...
module VeloPayments
  class PaymentV3
    ...
    def hash
      [payment_id, remote_id, currency, amount, source_account_name, payor_payment_id, payment_memo, payee, withdrawable, status, transmission_type, remote_system_id, payment_metadata].hash
    end
