...
module VeloPayments
  class PaymentV3
    ...
    def valid?
      ...
      return false if !@currency.nil? && @currency.to_s.length < 3
      status_validator = EnumAttributeValidator.new('String', ["SUBMITTED", "ACCEPTED", "REJECTED", "WITHDRAWN", "RETURNED", "AWAITING_FUNDS", "FUNDED", "UNFUNDED", "CANCELLED", "REQUESTED"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["SUBMITTED", "ACCEPTED", "REJECTED", "WITHDRAWN", "RETURNED", "AWAITING_FUNDS", "FUNDED", "UNFUNDED", "CANCELLED", "REQUESTED"])
    ...
    def hash
      [payment_id, remote_id, currency, amount, source_account_name, payor_payment_id, payment_memo, payee, withdrawable, status, transmission_type, remote_system_id, payment_metadata, auto_withdrawn_reason_code].hash
    end
