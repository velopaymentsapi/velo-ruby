...
module VeloPayments
  class CreatePayorLinkRequest
    attr_accessor :from_payor_id

    attr_accessor :link_type

    attr_accessor :to_payor_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::CreatePayorLinkRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::CreatePayorLinkRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @to_payor_id.nil?
        invalid_properties.push('invalid value for "to_payor_id", to_payor_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @to_payor_id.nil?
      true
    end
    ...
    def link_type=(link_type)
      validator = EnumAttributeValidator.new('String', ["PARENT_OF"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          from_payor_id == o.from_payor_id &&
          link_type == o.link_type &&
          to_payor_id == o.to_payor_id
    end
    ...
    def hash
      [from_payor_id, link_type, to_payor_id].hash
    end
