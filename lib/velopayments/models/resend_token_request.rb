...
module VeloPayments
  class ResendTokenRequest
    ...
    # Optional property that MUST be suppied when manually verifying a user <P> The user's smsNumber is registered via a separate endpoint and an OTP sent to them 
