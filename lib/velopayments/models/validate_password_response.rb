  ...
  class ValidatePasswordResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::ValidatePasswordResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::ValidatePasswordResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@score.nil? && @score > 4
        invalid_properties.push('invalid value for "score", must be smaller than or equal to 4.')
      end
    ...
    def valid?
      ...
      return false if !@score.nil? && @score > 4
    ...
    def score=(score)
      ...
      if score > 4
        fail ArgumentError, 'invalid value for "score", must be smaller than or equal to 4.'
      end
    ...
    def hash
      [score, valid, warning, suggestions].hash
    end
