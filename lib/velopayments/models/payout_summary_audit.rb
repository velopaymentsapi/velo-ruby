...
module VeloPayments
  class PayoutSummaryAudit
    ...
    def hash
      [payout_id, payor_id, status, date_time, submitted_date_time, instructed_date_time, total_payments, total_incomplete_payments, total_failed_payments, source_account_summary, fx_summaries, payout_memo].hash
    end
