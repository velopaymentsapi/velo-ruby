...
module VeloPayments
  ...
  class PayoutPayorIds
    ...
    attr_accessor :submitting_payor_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::PayoutPayorIds` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::PayoutPayorIds`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @payout_from_payor_id.nil?
        invalid_properties.push('invalid value for "payout_from_payor_id", payout_from_payor_id cannot be nil.')
      end

      if @payout_to_payor_id.nil?
        invalid_properties.push('invalid value for "payout_to_payor_id", payout_to_payor_id cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          submitting_payor_id == o.submitting_payor_id &&
    ...
    def hash
      [submitting_payor_id, payout_from_payor_id, payout_to_payor_id].hash
    end
