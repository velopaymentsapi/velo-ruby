...
module VeloPayments
  class GetPaymentsForPayoutResponseV3Summary
    ...
    def hash
      [payout_status, submitted_date_time, instructed_date_time, payout_memo, total_payments, confirmed_payments, released_payments, incomplete_payments, failed_payments].hash
    end
