...
module VeloPayments
  ...
  class PaymentRejectedOrReturned
    ...
    attr_accessor :payout_payor_ids
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::PaymentRejectedOrReturned` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::PaymentRejectedOrReturned`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payout_payor_ids')
        self.payout_payor_ids = attributes[:'payout_payor_ids']
      end
    ...
    def list_invalid_properties
      ...
      if @reason_message.nil?
        invalid_properties.push('invalid value for "reason_message", reason_message cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @reason_message.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payout_payor_ids == o.payout_payor_ids &&
    ...
    def hash
      [source_type, event_id, created_at, payment_id, payout_payor_ids, payor_payment_id, status, reason_code, reason_message].hash
    end
