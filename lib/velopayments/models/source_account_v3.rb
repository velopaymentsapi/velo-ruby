...
module VeloPayments
  class SourceAccountV3
    ...
    attr_accessor :total_payout_cost
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::SourceAccountV3` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::SourceAccountV3`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_payout_cost')
        self.total_payout_cost = attributes[:'total_payout_cost']
      else
        self.total_payout_cost = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @total_payout_cost.nil?
        invalid_properties.push('invalid value for "total_payout_cost", total_payout_cost cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @total_payout_cost.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          currency == o.currency &&
          total_payout_cost == o.total_payout_cost
    end
    ...
    def hash
      [source_account_name, source_account_id, currency, total_payout_cost].hash
    end
