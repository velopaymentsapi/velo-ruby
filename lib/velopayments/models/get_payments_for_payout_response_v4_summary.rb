...
module VeloPayments
  class GetPaymentsForPayoutResponseV4Summary
    ...
    def hash
      [payout_status, submitted_date_time, instructed_date_time, payout_memo, total_payments, confirmed_payments, released_payments, incomplete_payments, returned_payments].hash
    end
