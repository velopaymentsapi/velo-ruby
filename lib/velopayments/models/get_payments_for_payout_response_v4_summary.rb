...
module VeloPayments
  class GetPaymentsForPayoutResponseV4Summary
    ...
    def hash
      [payout_status, submitted_date_time, instructed_date_time, payout_memo, payout_type, quoted_date_time, submitting, payout_from, payout_to, quoted, instructed, withdrawn, total_payments, confirmed_payments, released_payments, incomplete_payments, returned_payments].hash
    end
