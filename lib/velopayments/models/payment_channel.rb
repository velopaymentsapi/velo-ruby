  ...
  class PaymentChannel
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::PaymentChannel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::PaymentChannel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'routing_no')
        self.routing_no = attributes[:'routing_no']
      end
    ...
    def list_invalid_properties
      ...
      if @routing_no.nil?
        invalid_properties.push('invalid value for "routing_no", routing_no cannot be nil.')
      end

      if @routing_no.to_s.length > 9
        invalid_properties.push('invalid value for "routing_no", the character length must be smaller than or equal to 9.')
      end

      if @routing_no.to_s.length < 9
        invalid_properties.push('invalid value for "routing_no", the character length must be great than or equal to 9.')
      end
      ...
      if @country_code.to_s.length > 9
        invalid_properties.push('invalid value for "country_code", the character length must be smaller than or equal to 9.')
      end

      if @country_code.to_s.length < 9
        invalid_properties.push('invalid value for "country_code", the character length must be great than or equal to 9.')
      end
    ...
    def valid?
      ...
      return false if @routing_no.nil?
      return false if @routing_no.to_s.length > 9
      return false if @routing_no.to_s.length < 9
      return false if @country_code.nil?
      return false if @country_code.to_s.length > 9
      return false if @country_code.to_s.length < 9
    ...
    # Custom attribute writer method with validation
    # @param [Object] routing_no Value to be assigned
    def routing_no=(routing_no)
      if routing_no.nil?
        fail ArgumentError, 'routing_no cannot be nil'
      end

      if routing_no.to_s.length > 9
        fail ArgumentError, 'invalid value for "routing_no", the character length must be smaller than or equal to 9.'
      end

      if routing_no.to_s.length < 9
        fail ArgumentError, 'invalid value for "routing_no", the character length must be great than or equal to 9.'
      end
    ...
    def country_code=(country_code)
      ...
      if country_code.to_s.length > 9
        fail ArgumentError, 'invalid value for "country_code", the character length must be smaller than or equal to 9.'
      end

      if country_code.to_s.length < 9
        fail ArgumentError, 'invalid value for "country_code", the character length must be great than or equal to 9.'
      end
    ...
    def hash
      [payment_channel_name, iban, account_number, routing_no, country_code, currency, account_name].hash
    end
