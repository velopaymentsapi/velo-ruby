...
module VeloPayments
  class PaymentResponseV4
    ...
    def self.openapi_types
      {
        ...
        :'rails_id' => :'String',
        :'country_code' => :'String',
        :'events' => :'Array<PaymentEventResponseV4>',
        :'return_cost' => :'Integer',
    ...
    def hash
      [payment_id, payee_id, payor_id, payor_name, quote_id, source_account_id, source_account_name, remote_id, source_amount, source_currency, payment_amount, payment_currency, rate, inverted_rate, is_payment_ccy_base_ccy, submitted_date_time, status, funding_status, routing_number, account_number, iban, payment_memo, filename_reference, individual_identification_number, trace_number, payor_payment_id, payment_channel_id, payment_channel_name, account_name, rails_id, country_code, events, return_cost, return_reason, rails_payment_id, rails_batch_id, rejection_reason, withdrawn_reason, withdrawable, payout].hash
    end
