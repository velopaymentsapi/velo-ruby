...
module VeloPayments
  class Error
    ...
    attr_accessor :localisation_details
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::Error` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::Error`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'localisation_details')
        self.localisation_details = attributes[:'localisation_details']
      end
    ...
    def valid?
      ...
      location_type_validator = EnumAttributeValidator.new('String', ["requestBody", "queryParam", "requestParam", "header", "pathParam"])
    ...
    def location_type=(location_type)
      validator = EnumAttributeValidator.new('String', ["requestBody", "queryParam", "requestParam", "header", "pathParam"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          localisation_details == o.localisation_details &&
          location == o.location &&
    ...
    def hash
      [error_message, error_code, localisation_details, location, location_type, reason_code, error_data].hash
    end
