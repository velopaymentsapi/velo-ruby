...
module VeloPayments
  class Error
    ...
    def valid?
      location_type_validator = EnumAttributeValidator.new('String', ["requestBody", "queryParam", "header", "pathParam"])
    ...
    def location_type=(location_type)
      validator = EnumAttributeValidator.new('String', ["requestBody", "queryParam", "header", "pathParam"])
