  ...
  class PayeePayorRefV4
    ...
    def self.openapi_types
      {
        ...
        :'invitation_status_timestamp' => :'Time',
        :'payment_channel_id' => :'String',
        :'payable_status' => :'Boolean',
        :'payable_issues' => :'Array<PayableIssueV4>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VeloPayments::PayeePayorRefV4` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VeloPayments::PayeePayorRefV4`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payable_status')
        self.payable_status = attributes[:'payable_status']
      end

      if attributes.key?(:'payable_issues')
        if (value = attributes[:'payable_issues']).is_a?(Array)
          self.payable_issues = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payable_status == o.payable_status &&
          payable_issues == o.payable_issues
    end
    ...
    def hash
      [payor_id, remote_id, invitation_status, invitation_status_timestamp, payment_channel_id, payable_status, payable_issues].hash
    end
