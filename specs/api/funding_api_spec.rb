...
# Unit tests for VeloPayments::FundingApi
...
describe 'FundingApi' do
  ...
  describe 'test an instance of FundingApi' do
    it 'should create an instance of FundingApi' do
      expect(@api_instance).to be_instance_of(VeloPayments::FundingApi)
    end
  end

  # unit tests for create_funding_request_v2
  ...
  # @return [nil]
  describe 'create_funding_request_v2 test' do
  ...
  # unit tests for get_funding_by_id_v1
  # Get Funding
  # Get Funding by Id
  # @param funding_id 
  # @param [Hash] opts the optional parameters
  # @return [FundingResponse]
  describe 'get_funding_by_id_v1 test' do
    skip "skipping test" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
