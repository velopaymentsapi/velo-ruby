...
# Unit tests for VeloPayments::WebhooksApi
...
describe 'WebhooksApi' do
  ...
  describe 'test an instance of WebhooksApi' do
    it 'should create an instance of WebhooksApi' do
      expect(@api_instance).to be_instance_of(VeloPayments::WebhooksApi)
    end
  end

  # unit tests for create_webhook_v1
  # Create Webhook
  # Create Webhook
  # @param [Hash] opts the optional parameters
  # @option opts [CreateWebhookRequest] :create_webhook_request 
  # @return [nil]
  describe 'create_webhook_v1 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_webhook_v1
  # Get details about the given webhook.
  # Get details about the given webhook.
  # @param webhook_id Webhook id
  # @param [Hash] opts the optional parameters
  # @return [WebhookResponse]
  describe 'get_webhook_v1 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for list_webhooks_v1
  ...
  describe 'list_webhooks_v1 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ping_webhook_v1
  # @param webhook_id Webhook id
  # @param [Hash] opts the optional parameters
  # @return [PingResponse]
  describe 'ping_webhook_v1 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_webhook_v1
  # Update Webhook
  # Update Webhook
  # @param webhook_id Webhook id
  # @param [Hash] opts the optional parameters
  ...
  # @return [nil]
  describe 'update_webhook_v1 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
